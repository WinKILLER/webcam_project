...
if("TRUE" STREQUAL "TRUE")
  set(pid_SOURCE_PREFIX /home/oos/catkin_ws/src/webcam_project/pid)
  set(pid_DEVEL_PREFIX /home/oos/catkin_ws/src/webcam_project/build-pid-Desktop-Default/devel)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'pid' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Carles Oro <carles.oro26@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'pid' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/oos/catkin_ws/src/webcam_project/pid/${idir}'.  Ask the maintainer 'Carles Oro <carles.oro26@gmail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/oos/catkin_ws/src/webcam_project/build-pid-Desktop-Default/devel/lib;/home/oos/catkin_ws/devel/lib;/opt/ros/indigo/lib)
