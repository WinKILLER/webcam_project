...
class RosImgProcessorNode
{
    ...
    protected:
        ...
        void detectorFacePixelsCallbacks(const std_msgs::Int32MultiArrayConstPtr& _msg);
        void kalmanFacePixelsCallbacks(const std_msgs::Int32MultiArrayConstPtr& _msg);
